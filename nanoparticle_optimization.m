...
warning(['nanoparticle_optimization.m is a compatibility entry point. ', ...
    'Running nanoparticle_optimization_submission_ready_v2.m instead.']);
run('nanoparticle_optimization_submission_ready_v2.m');
